...
/*   Updated: 2021/02/18 16:16:12 by lucas            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int argc, const char *argv[])
{
	...
	MODE::vector<int>		v1(12, 15);
	MODE::vector<int>::iterator	begin = v1.begin() + 3;
	MODE::vector<int>::iterator	end = v1.end();
	MODE::vector<int>	v2(begin, end);
...
//	std::vector<int>	v2(begin, end);
	...
	for (MODE::vector<int>::iterator ite = v2.begin() ;ite != v2.end(); ite++)
	...
	for (MODE::vector<int>::iterator ite = v1.begin(); ite != v1.end(); ite++)
		std::cout << *ite << std::endl;
...
//	v3.push_back(15);
	v3.resize(10, 100);
	v4.swap(v3);
	for (MODE::vector<int>::iterator i = v3.begin(); i != v3.end(); i++)
		std::cout  << *i << "\t";
	std::cout << "size end : " << v3.size() << std::endl;

{
  MODE::vector<int> foo (3,100);   // three ints with a value of 100
  MODE::vector<int> bar (2,200);   // two ints with a value of 200
